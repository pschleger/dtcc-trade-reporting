...
**Purpose**: Compares internal and external position data for discrepancies
**Workflow Context**: Multiple workflows utilizing ReconciliationResult entities
...
**API Contracts**:
- Input: ReconciliationResult entity with required data
