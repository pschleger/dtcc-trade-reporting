# validateBusinessRules Criterion Specification

## 1. Component Overview
**Component Name**: validateBusinessRules
**Component Type**: CyodaCriterion
**Business Domain**: Data Validation
**Purpose**: Evaluates whether trade passes business rule validation
**Workflow Context**: Multiple workflows requiring validateBusinessRules evaluation
