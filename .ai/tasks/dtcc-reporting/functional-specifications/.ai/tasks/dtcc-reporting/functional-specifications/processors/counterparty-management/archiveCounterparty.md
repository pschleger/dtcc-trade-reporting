...
**Purpose**: Archives decommissioned counterparty for regulatory compliance
**Workflow Context**: Multiple workflows utilizing Counterparty entities
...
**API Contracts**:
- Input: Counterparty entity with required data
